...
public final class JSONHelper {
	...
	public static <T> T map2obj(Map<?, ?> map, Class<T> clazz) throws Exception {
         return JSONHelper.fromJsonToObject(JSONHelper.toJSONString(JSONArray.fromObject(map)).toString(), clazz);
    }
	...
	public static <T> String toJSONString(List<T> list) {
		...
		jsonConfig.registerJsonValueProcessor(java.util.Date.class, new DateJsonValueProcessor("yyyy-MM-dd'T'HH:mm:ss.SSSZ"));  
